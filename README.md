...
source .venv/bin/activate  # or: conda activate twist2

# Export single checkpoint
cd legged_gym/legged_gym/scripts
python save_onnx.py --ckpt_path /path/to/model_XXXX.pt

# Example: export multiple checkpoints
for ckpt in 8000 10000 20000; do
  python save_onnx.py --ckpt_path /path/to/logs/g1_stu_future/your_exp/model_${ckpt}.pt
done
```
The ONNX files will be saved in the same directory as the `.pt` files.
